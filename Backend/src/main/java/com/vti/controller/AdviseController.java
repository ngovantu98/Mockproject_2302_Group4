...
import com.vti.dto.AdviseFormForCreating;
...
import com.vti.service.IAdviseService;
import com.vti.service.ITourService;

@RestController
@RequestMapping(value = "api/v1/advises")
public class AdviseController {

	@Autowired
	private IAdviseService service;
...
//	}
	...
	@PostMapping()
	public ResponseEntity<?> createAdvise(@RequestBody AdviseFormForCreating form) {
		service.createAdvise(form);
